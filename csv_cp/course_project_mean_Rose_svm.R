...
confusionMatrix(train$Exited,pred.1)          #Accuracy :  0.8786 
confusionMatrix(over$Exited,pred.1.over)     #Accuracy :   0.8579  
confusionMatrix(under$Exited,pred.1.under)  #Accuracy :    0.8571 
confusionMatrix(both$Exited,pred.1.both)  # Accuracy : 0.8814
