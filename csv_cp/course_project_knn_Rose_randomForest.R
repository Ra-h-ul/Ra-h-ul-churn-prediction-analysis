...
#evaluation------
confusionMatrix(predict(rf.train,test),test$Exited ) #Accuracy : 0.8593 
confusionMatrix(predict(rf.over,test),test$Exited )  #Accuracy : 0.8499
confusionMatrix(predict(rf.under,test),test$Exited )  #Accuracy : 0.7874
confusionMatrix(predict(rf.both,test),test$Exited )   #Accuracy : 0.8379
